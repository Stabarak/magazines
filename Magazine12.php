...
<html>
	...
	<body style="background-image:url('magazine-autralia1.jpg');background-position:center;padding-top:150px;background-repeat:no-repeat;background-size:cover;text-shadow:3px 2px 4px grey;">
		...
		<hr>
				<center>
					<a href="Category3.html" style="text-decoration:none"><h5>Back |</h5></a>
					<a href="menu.html" style="text-decoration:none"><h5> Home</h5></a>
				</center>
		<center>
		<div style="width:60%;" align="center">
		<fieldset style="width:100%;padding:10px;text-align:center" align="center"><legend>Film Fare</legend>
			<form action="http://localhost/magazine/Magazine12.php" method="get">
			<div align="center">
		...
		<center>
			<a href="Category3.html" style="text-decoration:none"><h5 align="left">Back |</h5></a>
...
{
	$query="select * from magz where mid=8";
...
{
		$query="select * from editors where magid=8";
	$result=mysqli_query($con,$query);
	while($row=mysqli_fetch_array($result))
	{	
...
elseif(isset($_GET['download']))
{
	...
	readfile('C:/xampp/htdocs/magazine/magazines/FilmFare3.pdf');
}
elseif(isset($_GET['publisher']))
{
		$query="select * from publisher where magid=8";
	$result=mysqli_query($con,$query);
	while($row=mysqli_fetch_array($result))
	{	
